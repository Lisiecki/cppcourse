...
int main(){
	...
	int iterb1 = rf_bisect<Funktion1>(f1, a, b, root, eps1); //Ausgabe: 1
	int iterb2 = rf_bisect<Funktion1>(f1, a, b, root, eps2); //Ausgabe: 1
	int iterb3 = rf_bisect<Funktion1>(f1, a, b, root, eps3); //Ausgabe: 1
	cout<<"Bisection:"<<endl;
	...
	cout<<"Bisection:"<<endl;
	int iterb = rf_bisect<Funktion2>(f2, -5.0, 5.0, root, eps); //Ausgabe: 1
